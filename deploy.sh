...
kubectl set image deployments/client-deployment client=torlowski/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=torlowski/multi-worker:$SHA